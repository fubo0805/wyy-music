...
__DEFINE__(1668770180035, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1668770180036,"./event-store":1668770180037}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1668770180036, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1668770180037, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1668770180036,"./utils":1668770180038}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1668770180038, function(require, module, exports) {
...
return __REQUIRE__(1668770180035);
})()
